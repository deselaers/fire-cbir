...
*/
#ifndef __dist_sqrtoneminusfidelity_hpp__
#define __dist_sqrtoneminusfidelity_hpp__
...
class SqrtOneMinusFidelityDistance : public BaseDistance {
public:
  ...
  virtual ::std::string name() {return "sqrtoneminusfidelity";}
