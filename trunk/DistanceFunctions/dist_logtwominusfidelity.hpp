...
*/
#ifndef __dist_logtwominusfidelity_hpp__
#define __dist_logtwominusfidelity_hpp__
...
class LogTwoMinusFidelityDistance : public BaseDistance {
public:
  ...
  virtual ::std::string name() {return "logtwominusfidelity";}
