...
*/
#ifndef __dist_histogramintersection_hpp__
#define __dist_histogramintersection_hpp__
...
class HistogramintersectionDistance : public BaseDistance {
public:
  ...
  virtual ::std::string name() {return "histogramintersection";}
